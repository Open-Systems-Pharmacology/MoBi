...
namespace MoBi.Presentation.MenusAndBars.ContextMenus
{
   public class MultipleBuildingBlockInfoNodeContextMenuFactory : MultipleNodeContextMenuFactory<IBuildingBlockInfo>
   {
      ...
      public MultipleBuildingBlockInfoNodeContextMenuFactory(IMoBiContext context, IContainer container)
      {
         _context = context;
      ...
      {
         return new MultipleBuildingBlockNodeContextMenu(buildingBlockInfos.Select(x => x.UntypedBuildingBlock).ToList(), _context, _container);
      }
