...
namespace MoBi.Presentation.Presenter
{
   ...
   class ObjectPathCreatorAtInitialCondition : ObjectPathCreatorBase, IObjectPathCreatorAtInitialCondition
   {
      public ObjectPathCreatorAtInitialCondition(IObjectPathFactory objectPathFactory, IAliasCreator aliasCreator, IMoBiContext context) : base(objectPathFactory, aliasCreator, context)
      {
      }
