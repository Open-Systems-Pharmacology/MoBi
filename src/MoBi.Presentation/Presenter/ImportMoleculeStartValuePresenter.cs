...
namespace MoBi.Presentation.Presenter
{
   ...
   public class ImportMoleculeStartValuePresenter : AbstractQuantitiesImporterPresenterForBuildingBlock<InitialConditionsBuildingBlock, InitialCondition>, IImportMoleculeStartValuePresenter
   {
