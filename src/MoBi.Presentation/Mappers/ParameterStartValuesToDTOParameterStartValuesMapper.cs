...
{
   public interface IParameterStartValueToParameterStartValueDTOMapper : IStartValueToStartValueDTOMapper<ParameterValue, ParameterStartValueDTO>
   {
   }
   ...
   public class ParameterStartValueToParameterStartValueDTOMapper : IParameterStartValueToParameterStartValueDTOMapper
   {
      ...
      public ParameterStartValueDTO MapFrom(ParameterValue parameterStartValue, IStartValuesBuildingBlock<ParameterValue> buildingBlock)
      {
