...
namespace MoBi.Presentation.Mappers
{
   ...
   public class ParameterToParameterDTOMapper : ObjectBaseToObjectBaseDTOMapperBase, IParameterToParameterDTOMapper
   {
      ...
      public ParameterToParameterDTOMapper(IFormulaToFormulaBuilderDTOMapper formulaToDTOFormulaBuilderMapper, ITagToTagDTOMapper tagMapper, IGroupRepository groupRepository, IFavoriteRepository favoriteRepository, IEntityPathResolver entityPathResolver)
      {
      ...
      public IParameterDTO MapFrom(IParameter parameter)
      {
         ...
         try
         {
            dto.Value = parameter.Value;
         }
         catch (Exception)
         {
            dto.Value = double.NaN;
         }
