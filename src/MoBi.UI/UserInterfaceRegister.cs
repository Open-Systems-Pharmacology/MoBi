...
namespace MoBi.UI
{
   public class UserInterfaceRegister : IRegister
   {
      public void RegisterInContainer(IContainer container)
      {
         ...
         container.Register<IMoBiMainView, MoBiMainView>(LifeStyle.Singleton);

         container.Register<IContainerModalView, ModalForm>();
         container.Register<IReactionDiagramPresenter, ReactionDiagramPresenter>();
         ...
         container.RegisterImplementationOf((IShell)mainView);
         container.RegisterImplementationOf((IMainView)mainView);
