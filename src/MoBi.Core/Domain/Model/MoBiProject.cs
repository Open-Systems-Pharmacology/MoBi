...
public class MoBiProject : Project
{
   ...
   public Module ModuleByName(string moduleName) => Modules.FindByName(moduleName);

   public void AddSimulation(IMoBiSimulation newSimulation) => _allSimulations.Add(newSimulation);
   ...
   public void AddChart(CurveChart chart) => _charts.Add(chart);

   public void RemoveChart(CurveChart chartToRemove) => _charts.Remove(chartToRemove);

   public void AddIndividualBuildingBlock(IndividualBuildingBlock individualBuildingBlock) => addBuildingBlock(individualBuildingBlock);

   public void AddExpressionProfileBuildingBlock(ExpressionProfileBuildingBlock expressionProfileBuildingBlock) => addBuildingBlock(expressionProfileBuildingBlock);

   private void addBuildingBlock(IBuildingBlock buildingBlock) => _buildingBlocks.Add(buildingBlock);

   public void RemoveIndividualBuildingBlock(IndividualBuildingBlock buildingBlockToRemove) => removeBuildingBlock(buildingBlockToRemove);

   public void RemoveExpressionProfileBuildingBlock(ExpressionProfileBuildingBlock buildingBlockToRemove) => removeBuildingBlock(buildingBlockToRemove);
