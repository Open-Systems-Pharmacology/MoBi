...
{
   public interface INameCorrector : INameAutoCorrector
   {
      /// <summary>
   ...
   internal class NameCorrector : NameAutoCorrector, INameCorrector
   {
      private readonly IObjectBaseNamingTask _namingTask;
      private readonly IObjectTypeResolver _objectTypeResolver;

      public NameCorrector(IObjectBaseNamingTask namingTask, IObjectTypeResolver objectTypeResolver, IContainerTask containerTask) : base(containerTask)
      {
