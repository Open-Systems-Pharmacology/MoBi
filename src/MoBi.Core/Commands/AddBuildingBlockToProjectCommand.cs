...
{
   public class AddBuildingBlockToProjectCommand<T> : MoBiReversibleCommand, ISilentCommand where T : class, IBuildingBlock
   {
      protected T _buildingBlock;
      public string BuildingBlockId { get; private set; }
      public bool Silent { get; set; }

      public AddBuildingBlockToProjectCommand(T buildingBlock)
      {
      ...
      {
         return new RemoveBuildingBlockFromProjectCommand<T>(_buildingBlock).AsInverseFor(this);
      }
