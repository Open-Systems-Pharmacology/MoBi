...
namespace MoBi.Core.Mappers
{
   public interface IMoleculeStartValuesBuildingBlockToParameterDataTableMapper
   {
      ...
      DataTable MapFrom(IEnumerable<InitialCondition> moleculeStartValues, IEnumerable<MoleculeBuilder> moleculeBuilders);
   }
   ...
   {
      public DataTable MapFrom(IEnumerable<InitialCondition> moleculeStartValues, IEnumerable<MoleculeBuilder> moleculeBuilders)
      {
      ...
      private void moleculeStartValueToParametersDataTable(InitialCondition moleculeStartValue, DataTable dt, string description)
      {
         var row = dt.Rows.Add();
