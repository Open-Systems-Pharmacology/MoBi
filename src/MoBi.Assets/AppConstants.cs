...
namespace MoBi.Assets
{
   public static class AppConstants
   {
      ...
      public static class Captions
      {
         ...
         public static readonly string AddAndEditPathsDescription = "You can add and edit paths by selecting the entity from the left and using the 'Add' button, or manually adding and editing paths.";
