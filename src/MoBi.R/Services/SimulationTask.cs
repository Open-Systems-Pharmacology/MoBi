...
namespace MoBi.R.Services
{
   ...
   {
      MoBiSimulation CreateSimulationFrom(string simulationName, ModuleConfiguration[] moduleConfigurations,
         ExpressionProfileBuildingBlock[] expressionProfiles = null,
   ...
   public class SimulationTask : ISimulationTask
   {
      ...
      public MoBiSimulation CreateSimulationFrom(string simulationName, ModuleConfiguration[] moduleConfigurations,
         ExpressionProfileBuildingBlock[] expressionProfiles = null,
         IndividualBuildingBlock individual = null)
      {
