...
namespace MoBi.Presentation
{
   public class concern_for_SelectableDTO<TSelectableDTO, TParentDTO> : ContextSpecification<TSelectableDTO> where TSelectableDTO : SelectableDTO<TSelectableDTO, TParentDTO> where TParentDTO : ContainsMultiSelectDTO<TSelectableDTO, TParentDTO>
   {
    ...
    public class concern_for_SelectMoleculesDTO : ContextSpecification<SelectMoleculesDTO>
    {
        ...
        {
            sut = new SelectMoleculesDTO();
        }
    }

    public class When_validating_the_dto_when_two_molecules_with_the_same_name_with_only_one_selected : concern_for_SelectMoleculesDTO
    {
        protected override void Context()
        {
            base.Context();
    ...
    public class When_validating_the_dto_when_building_blocks_are_selected : concern_for_SelectMoleculesDTO
    {
        protected override void Context()
        {
            base.Context();
    ...
    public class When_unselecting_a_molecule_that_makes_an_invalid_result_become_valid : concern_for_SelectMoleculesDTO
    {
        protected override void Context()
        {
            base.Context();
    ...
    public class When_selecting_a_molecule_that_makes_an_valid_result_become_invalid : concern_for_SelectMoleculesDTO
    {
        protected override void Context()
        {
            base.Context();
    ...
    public class When_validating_the_dto_when_two_molecules_with_the_same_name_and_both_are_selected : concern_for_SelectMoleculesDTO
    {
        protected override void Context()
        {
            base.Context();
