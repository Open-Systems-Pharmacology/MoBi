...
{
   internal class concern_for_SelectReferenceAtMoleculePresenter : ContextSpecification<SelectReferenceAtMoleculePresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtMoleculePresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtInitialCondition>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtMoleculePresenter : concern_for_SelectReferenceAtMoleculePresenter
   {
