...
{
   internal class concern_for_SelectReferenceAtReactionPresenter : ContextSpecification<SelectReferenceAtReactionPresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtReactionPresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtReaction>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtReactionPresenter : concern_for_SelectReferenceAtReactionPresenter
   {
