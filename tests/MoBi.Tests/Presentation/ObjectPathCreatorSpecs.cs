...
namespace MoBi.Presentation
{
   ...
   class When_creating_a_realtiv_path_to_a_local_moleculeProperty : concern_for_ObjectPathCreatorSpecs
   {
      ...
      protected override void Context()
      {
         ...
         var concentrationParameter = new Parameter().WithName("Concentration")
   ...
   class When_asking_objectpath_creator_for_an_absolute_path_for_an_molecule : concern_for_ObjectPathCreatorSpecs
   {
      ...
      private readonly string _parentName = "Parent";
      ...
      protected override void Context()
      {
         ...
         _dummyMolecule = new DummyMoleculeContainerDTO((new MoleculeAmount {Name = _moleculeName})) {Name = _moleculeName, MoleculePropertiesContainer = _moleculePropertiesDTO};
   ...
   public class When_asking_for_a_realtive_path_in_a_container_hierarchie : concern_for_ObjectPathCreatorSpecs
   {
      ...
      private readonly string _paraName = "Para";
      private readonly string _containerNameOne = "One";
      private readonly string _containerNameTwo = "TWO";
      private IDimension _rightDimension;
   ...
   class When_asking_abolute_object_path_creator_for_a_Molecule_Parameter_Reference : concern_for_ObjectPathCreatorSpecs
   {
      ...
      protected override void Context()
      {
         ...
         _dtoMoleculeParameter = new DummyParameterDTO(parameter).WithId("ID");
         _moleculeName = "Drug";
         var moleculeBuilder = new MoleculeBuilder().WithName(_moleculeName);
   ...
   class When_asking__object_path_creator_for_an_absolute_Molecule_Parameter_Reference : concern_for_ObjectPathCreatorSpecs
   {
      ...
      protected override void Context()
      {
         ...
         A.CallTo(() => _context.DimensionFactory).Returns(dimensionFactory);
         _parameterName = "Para";
         _parameter = new Parameter().WithName(_parameterName).WithId(_parameterName).WithDimension(_rightDimension);
         _dtoMoleculeParameter = new DummyParameterDTO(_parameter).WithName(_parameterName);
         var organ = new Container().WithName("Organ");
   ...
   public class When_asking_for_a_realtive_path_to_an_other_locaslMoleculeParameter_referenced_by_a_lokal_molecule_paramter : concern_for_ObjectPathCreatorAtMoleculeParameterSpecs
   {
      ...
      private IParameter _referenceParameter;
      private readonly string _paraName = "Para";
      private readonly string _containerName = "TWO";
      private IDimension _rightDimension;
   ...
   public class When_asking_for_a_realtive_path_to_Molecule_properties_parameter_for_the_same_molecule : concern_for_ObjectPathCreatorAtMoleculeParameterSpecs
   {
      ...
      protected override void Context()
      {
         ...
         _dtoDummy = new DummyParameterDTO(_parameter) {Parent = moleculeProperties, ModelParentName = "Drug"};
   ...
   public class When_asking_for_a_realtive_path_to_Molecule_properties_parameter_for_an_other_molecule : concern_for_ObjectPathCreatorAtMoleculeParameterSpecs
   {
      ...
      protected override void Context()
      {
         ...
         _dtoDummy = new DummyParameterDTO(_parameter) {Parent = moleculeProperties, ModelParentName = "Other"};
   ...
   public class When_asking_realtive_object_path_creator_for_a_Molecule_Reference_used_in_a_amount_observer : concern_for_ObjectPathCreatorAtAmountObserverSpecs
   {
      ...
      protected override void Context()
      {
         ...
         _dtoMoleculeParameter = new DummyParameterDTO(null).WithId(_parameterName).WithName(_parameterName);
         var organ = new Container().WithName("Organ");
         _container = new Container().WithName("Container");
         organ.Add(_container);
   ...
   public class When_asking_for_absolute_objectpath_for_an_local_Molecule_parameter_used_in_A_molecule_StartValue : concern_for_ObjectPathCreatorInitialCondition
   {
      ...
      private string _parameterName;
      private IContainer _container;
      private readonly string _containerName = "Compartment";
      private readonly string _organName = "Organ";
   ...
   public abstract class concern_for_ObjectPathCreatorAtMoleculeApplicationBuilder : ContextSpecification<IObjectPathCreator>
   {
      protected IMoBiContext _context;
   ...
   public class When_asking_for_a_relative_path_in_a_container_hierarchy_referenced_by_a_local_molecule_application_builder : concern_for_ObjectPathCreatorAtMoleculeApplicationBuilder
   {
      private ReferenceDTO _result;
      private IParameter _parameter;
      private IParameter _referenceParameter;
