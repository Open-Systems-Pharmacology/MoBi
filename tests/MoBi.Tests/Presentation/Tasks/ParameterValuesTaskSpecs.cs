...
namespace MoBi.Presentation.Tasks
{
   ...
   public class ComparingValueToOriginalParameter : concern_for_ParameterValuesTask
   {
      private ParameterValue _parameterValue;
      ...
      protected override void Context()
      {
         ...
         _parameterValue = DomainHelperForSpecs.ParameterValue;
         _parameterValue.Dimension = _dimension;
      ...
      protected override void Because()
      {
         _result = sut.IsEquivalentToOriginal(_parameterValue, _parameterValueBuildingBlock);
      }
   }

   public class When_original_parameter_cannot_be_found : ComparingValueToOriginalParameter
   {
      [Observation]
   ...
   public class When_original_parameter_can_be_found : ComparingValueToOriginalParameter
   {
      protected override void Context()
      {
         base.Context();
      ...
      [Observation]
      public void parameterValue_and_builder_are_equivalent()
      {
         _result.ShouldBeTrue();
      }
   }

   public class When_original_parameter_can_be_found_but_its_formula_cannot_be_evaluated : ComparingValueToOriginalParameter
   {
      protected override void Context()
      {
         base.Context();
      ...
      [Observation]
      public void parameterValue_and_builder_are_not_equivalent()
      {
         _result.ShouldBeFalse();
      }
   }
