...
{
   public class concern_for_ExpressionProfileToParameterValuesMapper : ContextSpecification<ExpressionProfileToParameterValuesMapper>
   {
   ...
   public class mapping_from_expression_profile_to_values_building_block : concern_for_ExpressionProfileToParameterValuesMapper
   {
