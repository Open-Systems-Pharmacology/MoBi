...
{
   internal class concern_for_SelectReferenceAtEventPresenter : ContextSpecification<SelectReferenceAtEventPresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtEventPresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtEvent>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtEventPresenter : concern_for_SelectReferenceAtEventPresenter
   {
      ...
      {
         sut.Init(_entity, new[] { _entity }, _eventBuilder);
      }
