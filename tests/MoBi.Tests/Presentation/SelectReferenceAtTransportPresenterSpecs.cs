...
{
   internal class concern_for_SelectReferenceAtTransportPresenter : ContextSpecification<SelectReferenceAtTransportPresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtTransportPresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtTransport>(),
            A.Fake<ITransportMoleculeContainerToObjectBaseDTOMapper>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtTransportPresenter : concern_for_SelectReferenceAtTransportPresenter
   {
