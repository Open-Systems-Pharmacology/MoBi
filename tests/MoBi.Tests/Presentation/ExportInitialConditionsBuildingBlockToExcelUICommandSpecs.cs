...
{
   public abstract class ExportInitialConditionsBuildingBlockToExcelUICommandSpecs : ContextSpecification<ExportInitialConditionsBuildingBlockToExcelUICommand>
   {
      protected IMoBiProjectRetriever _projectRetriever;
      protected IDialogCreator _dialogCreator;
      protected IInitialConditionsBuildingBlockToDataTableMapper _mapper;
      protected InitialConditionsBuildingBlock _buildingBlock;

      protected override void Context()
      {
         _buildingBlock = A.Fake<InitialConditionsBuildingBlock>();
         _projectRetriever = A.Fake<IMoBiProjectRetriever>();
         _dialogCreator = A.Fake<IDialogCreator>();
         _mapper = A.Fake<IInitialConditionsBuildingBlockToDataTableMapper>();

         A.CallTo(() => _buildingBlock.Name).Returns("InitialConditions");
         sut = new ExportInitialConditionsBuildingBlockToExcelUICommand(A.Fake<IInitialConditionsTask<InitialConditionsBuildingBlock>>(),_mapper) { Subject = _buildingBlock };
      }
   }
   ...
   public class When_exporting_initial_conditions_with_project_name : ExportInitialConditionsBuildingBlockToExcelUICommandSpecs
   {
      ...
      {
         base.Context();
         _defaultFileName = "project_InitialConditions_Building_Block";
