...
{
   internal class concern_for_SelectReferenceAtReactionParameterPresenter : ContextSpecification<SelectReferenceAtReactionParameterPresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtReactionParameterPresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtReactionParameter>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtReactionParameterPresenter : concern_for_SelectReferenceAtReactionParameterPresenter
   {
