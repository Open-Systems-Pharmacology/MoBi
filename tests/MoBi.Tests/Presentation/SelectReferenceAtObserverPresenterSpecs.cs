...
{
   internal class concern_for_SelectReferenceAtObserverPresenter : ContextSpecification<SelectReferenceAtContainerObserverPresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtContainerObserverPresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtObserver>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtObserverPresenter : concern_for_SelectReferenceAtObserverPresenter
   {
