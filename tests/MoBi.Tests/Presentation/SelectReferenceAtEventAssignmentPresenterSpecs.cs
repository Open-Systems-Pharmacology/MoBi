...
{
   internal class concern_for_SelectReferenceAtEventAssignmentPresenter : ContextSpecification<SelectReferenceAtEventAssignmentPresenter>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new SelectReferenceAtEventAssignmentPresenter(_view,
            ...
            A.Fake<IObjectPathCreatorAtEventAssignment>(),
            A.Fake<IBuildingBlockRepository>());
      }
   }

   internal class When_initializing_the_SelectReferenceAtEventAssignmentPresenter : concern_for_SelectReferenceAtEventAssignmentPresenter
   {
