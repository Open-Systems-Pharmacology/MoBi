...
namespace MoBi.ProjectConversion.v3_1
{
   public abstract class concern_for_ParameterStartValueDimensionRetriever : ContextSpecification<IParameterStartValueDimensionRetriever>
   {
   ...
   internal class When_retieving_a_dimension_for_a_paramter_start_value : concern_for_ParameterStartValueDimensionRetriever
   {
