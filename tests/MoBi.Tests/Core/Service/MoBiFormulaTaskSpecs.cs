...
public abstract class concern_for_MoBiFormulaTask : ContextSpecification<MoBiFormulaTask>
{
   ...
   protected override void Context()
   {
      ...
      sut = new MoBiFormulaTask(_context, _formulaTask, _nameCorrector, _quantityTask, _parametersInBuildingBlockRetriever);
...
public class When_creating_a_new_mobi_formula_for_a_given_building_block : concern_for_MoBiFormulaTask
{
   ...
   protected override void Because()
   {
      (_command, _formula) = sut.CreateNewFormulaInBuildingBlock(typeof(ConstantFormula), _formulaDimension, _buildingBlock, "FORMULA");
   }

   [Observation]
   public void should_return_a_formula_having_the_expected_type()
   {
